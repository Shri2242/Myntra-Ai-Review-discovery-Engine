...
const DEFAULT_INSIGHTS = {
  ...
  emergingTrends: [
    { theme: "Sizing Calibration (cm)", thisWeek: 28, lastWeek: 14, growthPct: 100, count: 42 },
    { theme: "Fabric Translucency Badging", thisWeek: 21, lastWeek: 14, growthPct: 50, count: 35 },
    { theme: "Wishlist Sub-Folders", thisWeek: 28, lastWeek: 18, growthPct: 55, count: 56 },
  ],
  featureRequests: [
    {
      theme: "Features",
